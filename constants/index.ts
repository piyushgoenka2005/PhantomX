...
export const TESTIMONIALS: Testimonial[] = [
  {
    quote: "Since we introduced PhantomX, the team can now quickly learn the theoretical and practical sides of penetration testing with very in-depth and up-to-date materials. To spice up the learning, we have a \"Hacker of the Month\" where we recognize the most progressive employee in our lab environment.",
  ...
  {
    quote: "PhantomX has been great for recruitment to quickly establish the caliber of ethical hacking candidates. The platform provides a credible overview of a professional's skills and ability when selecting the right hire. An active PhantomX profile strengthens a candidate's position in the job market, making them stand out from the crowd and highlighting their commitment to skill development.",
    author: "Ryan Virani",
